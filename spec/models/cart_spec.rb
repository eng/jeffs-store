...
describe Cart do
  ...
  # This is a literal translation, but it's not the best method -WHB
  # before :each do
  ...
  let (:mms) { FactoryGirl.create(:product, name: "M&Ms", price: 1.0) }
  let (:jersey) { FactoryGirl.create(:product, name: "Blackhawks Jersey", price: 40.0) }
  let (:products) { [mms, jersey] }
